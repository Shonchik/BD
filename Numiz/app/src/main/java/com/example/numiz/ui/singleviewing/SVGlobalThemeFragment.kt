...
import com.example.numiz.databinding.FragmentSVGlobalThemeBinding
...
@AndroidEntryPoint
class SVGlobalThemeFragment : Fragment() {

    private lateinit var binding: FragmentSVGlobalThemeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSVGlobalThemeBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.upd.setOnClickListener {
            ...
            navController.navigate(R.id.UGlobalThemeFragment, bundle)
        }
